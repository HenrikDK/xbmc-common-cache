class MockCacheDepends:
    ...
    def mock(self):
        ...
        sys.modules["__main__"].plugin = "StorageClient Beta-1.4.0"
    ...
    def mockXBMC(self):
        ...
        sys.modules["__main__"].xbmc.getCondVisibility = Mock()
        sys.modules["__main__"].xbmc.getCondVisibility.return_value = False
